@extends('layouts.monitoring-one')
...
function getCorrective() 
{
	...
	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: url + '/monitoring/getCorrective',
		data: { 
			"_token": "{{ csrf_token() }}",
...
<div class="row">
	<div class="col-lg-6 col-sm-6">
		...
		<div class="panel panel-default">
			<div class="panel-heading"> PREVENTIVE MAINTENANCE <span style="color:#2979FF">2 HARI KEDEPAN</span></div>
			<div class="panel-wrapper collapse in">
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="row">
								...
								<div class="col-lg-2 col-sm-2" align="left" >
	...
	<div class="col-lg-6 col-sm-6">
		...
		<div class="panel panel-default">
			...
			<div class="panel-heading"> CORRECTIVE MAINTENANCE</div>
			<div class="panel-wrapper collapse in">
