...
<script type="text/javascript">
	...
	$(document).on("click", "#dailymtstitle", function() {
		$('#dailymtscontent').html('');
		$.ajax({
			url: url + '/dashboards/mtsdaily',
			type: 'GET',
			dataType: 'json',
			success: function(data) {
				$('#dailymtscontent').html(data.output);
				$('#dailymtspopup').modal('show');
			}
		})
	});

	$(document).on("click", "#dailymtrtitle", function() {
		$('#dailymtrcontent').html('');
		$.ajax({
			url: url + '/dashboards/mtrdaily',
			type: 'GET',
			dataType: 'json',
			success: function(data) {
				$('#dailymtrcontent').html(data.output);
				$('#dailymtrpopup').modal('show');
			}
		})
	});
</script>
...
<div class="row">
	<div class="col-lg-2 col-sm-12">
		<div class="panel panel-default">
			<div id="dailymtstitle" class="panel-heading"><i class="ti-calendar"></i> DAILY</div>
...
<div class="row">
	<div class="col-lg-2 col-sm-12">
		<div class="panel panel-default">
			<div id="dailymtrtitle" class="panel-heading"><i class="ti-calendar"></i> DAILY</div>
			<div class="panel-wrapper collapse in">
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
<!-- POP UP -->
<div id="dailymtspopup" class="modal fade bs-example-modal-accordion" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="panel-group" id="dailymtscontent"></div>
...
<div id="dailymtrpopup" class="modal fade bs-example-modal-accordion" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="panel-group" id="dailymtrcontent"></div>
			<div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div>
		</div>
	</div>
</div>
