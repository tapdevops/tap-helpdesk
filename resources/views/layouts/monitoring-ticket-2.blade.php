				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="row">
								<center><span style="font-weight:bold;font-size:15px" class="">MEAN TIME TO RESPONSE ( PROSES TIKET DIATAS 1 JAM )</span></center>
									...
									<?php 
										...
										if(!empty( $pdsj ))
										{
											...
											foreach( $pdsj as $k => $v )
											{
												...
												//$l .= "<td align='center'>{$v['selisih_waktu']} Hour</td>";
												$l .= "</tr>";
												$no++;
											}
											echo $l;
